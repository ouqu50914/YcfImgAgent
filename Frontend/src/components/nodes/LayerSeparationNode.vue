...
.layer-separation-node :deep(.el-input__inner),
.layer-separation-node :deep(.el-textarea__inner) {
    color: #b0b0b0;
}

.layer-separation-node :deep(.el-input__inner::placeholder),
.layer-separation-node :deep(.el-textarea__inner::placeholder) {
    color: #808080;
}
