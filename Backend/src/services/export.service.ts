...
export class ExportService {
    ...
    private getModelLabels(): Record<string, string> {
        return {
            ...
            "gpt-image-2.5-sunburst": "GPT-Image-2.5-pro(绘图)",
            "gpt-image-2.5-sunburst (anyfast)": "GPT-Image-2.5-pro(AnyFast)",
            "gpt-image-2.5-flare": "GPT-Image-2.5-Fast(绘图)",
            "gpt-image-2.5-flare (anyfast)": "GPT-Image-2.5-Fast(AnyFast)",
            "nano (ace)": "Nano(Ace)",
