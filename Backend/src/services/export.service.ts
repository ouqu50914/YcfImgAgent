...
export class ExportService {
    ...
    private getModelLabels(): Record<string, string> {
        return {
            ...
            "gpt-image-2-c": "GPT-Image-2-C(绘图)",
            "gpt-image-2-c (anyfast)": "GPT-Image-2-C(AnyFast)",
            "gpt-image-2.5-sunburst": "GPT2.5 pro(绘图)",
            "gpt-image-2.5-sunburst (ace)": "GPT2.5 pro(Ace)",
            "gpt-image-2.5-sunburst (anyfast)": "GPT2.5 pro(AnyFast)",
            "gpt-image-2.5-flare": "GPT2.5(绘图)",
            "gpt-image-2.5-flare (ace)": "GPT2.5(Ace)",
            "gpt-image-2.5-flare (anyfast)": "GPT2.5(AnyFast)",
            "nano (ace)": "Nano(Ace)",
            "nano (anyfast)": "Nano(AnyFast)",
            "gemini-3.1-flash-image (anyfast)": "Gemini-3.1-Flash(AnyFast)",
            "gemini-3-pro-image (anyfast)": "Gemini-3-Pro(AnyFast)",
