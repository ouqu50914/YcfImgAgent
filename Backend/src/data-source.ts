...
export const AppDataSource = new DataSource({
    ...
    entities: [User, ApiConfig, ImageResult, OperationLog, UserDailyQuota, WorkflowTemplate, WorkflowHistory, PromptTemplate, WorkflowCategory, UserCreditApplication, CreditUsageLog, SystemConfig, VideoTask, ChatMedia, ChatSessionRecord, SkillDefinition],
    subscribers: [],
    migrations: [],
});